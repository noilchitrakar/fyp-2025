              ...
              transactions.map((transaction: any) => (
                ...
                >
                  ...
                  <div className="flex items-center">
                    ...
                    {/* to display transaction description and date  */}
                    <div>
                  ...
                  {/* to display the transcation amount  */}
                  <span
          ...
          <div className="space-y-4">
            {rewards.length > 0 ? (
              rewards.map((reward: any) => (
                // this div will show the style for the rewards
                <div
                  key={reward.id}
                ...
                >
                  ...
                  {reward.id === 0 ? (
                    ...
                    //blockchain section(the idea here is to convert the native wastesnap coin to crypto currenct token
              ...
              //if there is nothing coming from the rewards
